...
namespace Interface_5
{
    class Order
    {
        ...
        {
            Globals.db = new MySqlConnection("SERVER=mysql-projetkitbox.alwaysdata.net;PORT=3306;DATABASE=projetkitbox_db;UID=207353_thomas	;PWD=Y@sqydv6Yp798Xy; old guids=true");
